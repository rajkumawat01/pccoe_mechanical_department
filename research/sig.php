        ...
        <div id="flush-collapse2" class="accordion-collapse collapse" aria-labelledby="flush-heading2" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">
            <div class="row my-3">
              ...
              <div class="col-lg-4 col-md-6">
                <p class="text-dark fw-bold">Team:</p>
                <center><img src="../faculty photo/ARoy_website.jpg" class="img-thumbnail mb-3" alt="Mr-Sanjay-Matekar" style="width: 150px;">
               </center><p class="text-dark fw-bold"> Dr. Anindita Roy (convener)  & team</p>
              </div>
              <div class="col-lg-4 col-md-12">
          ...
          <div class="accordion-body">
            <div class="row my-3">
              ...
              <div class="col-lg-4 col-md-6">
               ...
               </center><p class="text-dark fw-bold">Prof. U.I. Shaikh & (convener) & team</p>
              </div>
              <div class="col-lg-4 col-md-12">
