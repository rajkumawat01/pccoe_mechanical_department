...
<head>
    ...
    <title>BOS | About us | Department of Mechanical Engineering at PCCOE</title>
    <style></style>
</head>
     ...
     <div class="container p-2 mt-4 bos-section">
        ...
        <div class="container table-responsive content-panel bg-light p-3 shadow">
            ...
            <table class="table table-bordered my-table">
                <tbody>
                    <thead style="background-color: rgba(235, 235, 252, 0.781);color: #49688e;">
                    ...
                    <tr>
                        ...
                        <td>Dr. Padmakar A. Deshmukh, Professor <br>Head of Department</td>
                        <td>Chairman</td>
                        <td>Ex-officio</td>
                    </tr>
                    <!--<tr>
                        <td class="text-center">2</td>
                        <td>Dr. S. S. Lakade, Professor <br>Specialization: Production Engineering </td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>-->
                    <tr>
                        <td class="text-center">2</td>
                        <td>Dr. Narendra R. Deore, Professor<br>Specialization: Computational Fluid Dynamics</td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">3</td>
                        <td>Dr. P. R. Kale, Professor<br>PG Coordinator - Design Engineering </td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">4</td>
                        <td>Dr. Anindita Roy, Associate Professor,<br> PG Coordinator - Heat Power Engineering</td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">5</td>
                        <td>Mr. A. A. Panchwadkar, Associate Professor<br>Specialization: Noise Vibration & Harshness</td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">6</td>
                        <td>Dr. C. L. Ladekar, Associate Professor<br>Specialization: Heat Transfer</td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">7</td>
                        <td>Dr. U. G. Potdar, Associate Professor<br>Specialization: Combustion</td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">8</td>
                        <td>Mr. Sanjiwan K. Bhoite, Associate Professor<br>Specialization: Metallurgy</td>
                        <td>Chairman</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">9</td>
                        <td>Mr. Sanjay P. Salve, Associate Professor<br>Specialization: Refrigeration & Air Conditioning </td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">10</td>
                        <td>Mr. N. Vivekanandan, Asst. Professor<br>Specialization: Industrial Safety</td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">11</td>
                        <td>Mr. L. V. Awadhani – Associate Professor<br>Module Coordinator – Design Engineering </td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">12</td>
                        <td> Mr. S. B. Matekar – Associate Professor<br>Module Coordinator – Production & Automation</td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">13</td>
                        <td>Mr. U. I. Shaikh – Asst. Professor<br>Module Coordinator – Thermal Engineering </td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">14</td>
                        <td>Mr. Amol V. Suryavanshi – Asst. Professor<br>Module Coordinator - Engineering Sciences</td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
                        <td class="text-center">15</td>
                        <td>Dr. R. B. Ingle, Professor,<br>Dean Academics Cummins COE, Pune</td>
                        <td>University Nominee</td>
                        <td>VC - SPPU</td>
                    </tr>
                    <tr>
                        <td class="text-center">16</td>
                        <td>Mr. Shirish Bavdekar, Head of Talent Acquisition, 3DPLM, Daussalt system,Pune</td>
                        <td>Industry Representative</td>
                        <td>Chairman</td>
                    </tr>
                    <tr>
                        <td class="text-center">17</td>
                        <td>Dr. D. G. Thakur, Professor,<br>Department of Mechanical Engineering,<br>Defense Institute of Advanced Technology, Pune</td>
                        <td>Subject Expert other than Parent University</td>
                        <td>Academic Council</td>
                    </tr>
                    <tr>
                        <td class="text-center">18</td>
                        <td>Dr. Nitin Gulhane, Professor,<br>VJTI Mumbai </td>
                        <td>Subject Expert other than Parent University</td>
                        <td>Academic Council</td>
                    </tr>
                    <tr>
                        <td class="text-center">19</td>
                        <td>Mr.Sham Bhagat<br>Sr. Engineer, Whirlpool India Ltd.</td>
                        <td>PG Meritorious Alumnus</td>
                        <td>Chairman</td>
                    </tr>
                    <tr>
                        <td class="text-center">20</td>
                        <td>Dr. Suhas S. Mohite, Professor,<br>Mechanical Department, COEP, Pune </td>
                        <td>Academic Representative</td>
                        <td>Invitee</td>
                    </tr>
                    <tr>
                        <td class="text-center">21</td>
                        <td>R. Radhakrishnan, Director,<br>Pentagon Assembly Automation Pvt Ltd, Pune</td>
                        <td>Industry Representative</td>
                        <td>Invitee</td>
                    </tr>
                </tbody>
            ...
            <div class="">
                <h4>Functions of Board of Studies</h4>
                <ul class="my-list">
                    <li>To assist in preparing syllabi for various courses keeping in view the objectives of the college, interest of the stakeholders and national requirement for consideration and approval of the Academic Council;</li>
                    <li>Suggest methodologies for innovative teaching and evaluation techniques;</li>
                    <li>Suggest panel of names to the Academic Council for appointment of examiners</li>
                    <li>Co-ordinate research, teaching, extension and other academic activities in the department/college.</li>
                </ul>
            </div>
            <div class="section-2">
