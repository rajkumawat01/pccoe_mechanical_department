...
<head>
    ...
    <title>Notices and Announcement | News | Department of Mechanical Engineering at PCCOE</title>
    <style></style>
</head>
...
<br><br>
    ...
    <div class="container">
      <div class="row border-5 border-start border-primary shadow mb-4 ps-3 py-2 align-self-center text-dark mt-4">
          <h2>Notices and Announcement</h2>
      </div>
    </div>
    <div class="container p-2 news-page-section bg-light mt-3">
    <div class="pt-4">
        <ul class="fa-ul">
            <li>
            ...
            <li>
                ...
                <a  target="_blank" href="../vender/files/notices/insem circular.pdf">
                  TE/BE insem examination circular of sem-1 AY-2021-22 notice to student.
                </a>
            </li>
            <li>
              <span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
